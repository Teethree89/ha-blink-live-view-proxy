...
If HACS is installed, you can install this part as a custom repository instead:

1. Open HACS.
2. Open the three-dot menu.
3. Choose Custom repositories.
4. Add `https://github.com/Teethree89/ha-blink-live-view-proxy`.
5. Select category `Integration`.
6. Download the integration and restart Home Assistant.

HACS installs only the Home Assistant custom integration. You still need the
local proxy service from steps 1-4 on a Linux host with Python and `ffmpeg`.
